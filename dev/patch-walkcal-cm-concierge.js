...
if (APPLY) {
  ...
  for (const must of ['cm: f["Construction Manager"] || ""', 'concierge: f["Assigned Concierge"] || ""', 'header: "Construction Manager"', 'header: "Concierge"', 'r.inspApproved ? "Yes" : "No", r.cm, r.concierge']) {
